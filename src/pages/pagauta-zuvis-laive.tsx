...
import CaughtFishesOnBoat from "../components/fishing/CaughtFishesOnBoat";
...
const CaughtFishesOnBoatPage = () => {
  ...
  return (
    <>
      ...
      >
        <Container>
          {isMobile || <BackButton onClick={() => router.push("/zurnalas")} />}
          <CaughtFishesOnBoat onSetLocation={setLocation} />
        </Container>
      </DefaultLayout>
    </>
  );
