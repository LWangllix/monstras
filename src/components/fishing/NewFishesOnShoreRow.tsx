...
export interface NewFishesOnShoreRowRow {
  fishTypes: Array<FishType>;
  item: { type: FishType; weight: string };
...
export default NewFishesOnShoreRow;
